...
![image-20210527065050479](https://img.Victor.cn/image-20210527065050479.png)
...
![image-20210527070628394](https://img.Victor.cn/image-20210527070628394.png)
...
![image-20210527071827101](https://img.Victor.cn/image-20210527071827101.png)
...
在`themes`目录下新建文件`xxxx.omp.json` 比如 `Victor.omp.json`

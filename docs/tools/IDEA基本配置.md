...
这里有一份我的[配置文件](https://pan.Viktor.cn/s/Bpf0)，在最后也会说明配置的导入与导出。
...
![image-20220106052026798](https://img.Viktor.cn/image-20220106052026798.png)

### 修改 Maven 依赖仓库位置

一般 Maven 所下载的依赖都会存储在`C:\User\{user}\.m2\repository` ，通过下图位置可以将其移动到其他地方。

![image-20220106052100190](https://img.Viktor.cn/image-20220106052100190.png)

## 配置导入与导出

具体操作如下图，根据自己需要进行导入与导出

![image-20220616135757525](https://img.Viktor.cn/image-20220616135757525.png)

导出

![image-20220616135810570](https://img.Viktor.cn/image-20220616135810570.png)

导入

![image-20220616135847464](https://img.Viktor.cn/image-20220616135847464.png)
